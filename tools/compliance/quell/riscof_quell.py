...
class quell(pluginTemplate):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.isa_spec = os.path.join(cwd, 'quell/quell_isa.yaml')
        self.platform_spec = os.path.join(cwd, 'quell/quell_platform.yaml')
    ...
    def doRunTest(self, test_entry):
        ...
        cmd = (f'{self.compiler_name_prefix}-gcc '
                ...
                '-nostartfiles '
                '-g '
                f'-T {os.path.join(os.getcwd(), "quell/env/link.ld")} '
                f'-I {os.path.join(os.getcwd(), "quell/env/")} '
